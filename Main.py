...
def main():
    ...
    for prof_name, login_details in GV.PROFILES.items():
        ...
        for i in range(1, GV.NUMBER + 1):
            try:  # in case the program crushes, restart and complete the task
                ...
                driver, profile_data = scrape.scrape_profile(profile_driver_loaded, num_pics)
    ...
    print('extracted data from ' + str(counter)+' out of ' + str(GV.NUMBER * len(GV.PROFILES)) + ' profiles attempted')
